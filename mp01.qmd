...
```
The Stranger Things franchise has dominated Netflix, with over `r scales::comma(stranger_total_hours)` hours viewed 
and a presence in the Top 10 for `r stranger_max_weeks` weeks. Its cultural impact rivals other English-language juggernauts such as `r comparable_show_1` and `r comparable_show_2`, underscoring the show’s massive international appeal.
