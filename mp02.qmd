...
![](images/extracredit1.png){fig-cap="Albuquerque permits peak year" fig-alt="Bar chart of permits in Albuquerque by year" width=100% fig-align="center"}
...
> `POPULATION/HOUSEHOLDS/INCOME/RENT`: `(GEOID, year)` 
• `PERMITS`: `(GEOID, year)`\n
• `WAGES`: `(FIPS, YEAR, INDUSTRY)`\n
